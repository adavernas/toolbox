function F = Ffun33_(Vzero,ah,ai,deltah,deltai,e,gammah,gammai,kappa_p,mue,psii,q,sigqk,sigqs,sigz,veh,vei,vh,vi,vzh,vzi,z,zetah,zetai)
%FFUN33_
%    F = FFUN33_(VZERO,AH,AI,DELTAH,DELTAI,E,GAMMAH,GAMMAI,KAPPA_P,MUE,PSII,Q,SIGQK,SIGQS,SIGZ,VEH,VEI,VH,VI,VZH,VZI,Z,ZETAH,ZETAI)
